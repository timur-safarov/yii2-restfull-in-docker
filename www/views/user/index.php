...
$this->title = UserManagementModule::t('back', 'Пользователи');
		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-sm-6">
					<p>
						<?= GhostHtml::a(
							'<span class="glyphicon glyphicon-plus-sign"></span> Создать пользователя',
							['/user/create'],
			...
			<?= GridView::widget([
				...
				'columns' => [
					...
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									UserManagementModule::t('back', 'Изменить пароль'),
					...
					[
						...
						'label' => 'Статус',
						'optionsArray'=>[
							[User::STATUS_ACTIVE, UserManagementModule::t('back', 'Активен'), 'success'],
							[User::STATUS_INACTIVE, UserManagementModule::t('back', 'Отключен'), 'warning'],
							[User::STATUS_BANNED, UserManagementModule::t('back', 'Забанен'), 'danger'],
						],
					],
