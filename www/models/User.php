...
class User extends \webvimark\modules\UserManagement\models\User implements IdentityInterface
{
    ...
    public static function findIdentityByAccessToken($token, $type = null) {
        ...
        // return static::findOne(['auth_key' => $token]) && static::findOne(['auth_key' => $token])::hasRole('user23');

        // $mUser = static::findOne(['auth_key' => $token]);
        // return $mUser && $mUser::hasRole('user23');
